...
class Image(models.Model):
    ...
    image_file = FilerImageField(null=False, blank=False, max_length=5000,
...
class Category(models.Model):
    ...
    name_cn = models.CharField(max_length=255, null=False, blank=False,
                               help_text='The name of the category')
    order = models.IntegerField(default=0, null=False, blank=False,
                                help_text='The order of this category')
    is_full_size = models.BooleanField(null=False, blank=False, default=False,
